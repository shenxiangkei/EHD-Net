...
def default_argument_parser():
    ...
    port = 2 ** 15 + 2 ** 14 + hash(os.getuid()) % 2 ** 14 + 2
...
class DefaultPredictor:
    ...
    def __call__(self, original_image):
        ...
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            ...
            # print('flops: %.2f G, params: %.2f M' % (flops / 1e9, total / 1e6))
            # from fvcore.nn import parameter_count_table,FlopCountAnalysis
            # flopss=FlopCountAnalysis(self.model,([inputs],))
            # print(flopss.total())
            # from ptflops import get_model_complexity_info
            # a=1
            # macs, params = get_model_complexity_info(self.model, (3,800,800), as_strings=True,print_per_layer_stat=False, verbose=True)
    ...
    def build_hooks(self):
        ...
        ret = [
            ...
            hooks.PreciseBN(
                ...
                self.model,
                # Build a iOD data loader to not affect training
