...
# Type of pooling operFREEZEion applied to the incoming feature map for each RoI
...
# Enable Mean_Teacher
_C.DISTILL.MEAN_TEACHER = False
# Set Mean_Teacher's alpha
_C.DISTILL.MEAN_TEACHER_ALPHA = 0.9
...
_C.FINETUNE.USE_IMAGE_STORE = True