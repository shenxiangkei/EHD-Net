...
class GeneralizedRCNN(nn.Module):
    ...
    def get_warp_loss(self, all_images_in_store):
        ...
        for image in all_images_in_store:
            ...
            features,_ = self.backbone(img.tensor)
    ...
    def forward(self, batched_inputs):
        ...
        if self.base_model is not None and self.enable_backbone_distillation:
            prev_features,param = self.base_model.backbone(images.tensor)
            backbone_dist_loss = backbone_loss(features, prev_features,param)
